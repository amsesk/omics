...
class NcbiSraExperimentPackageSet (object):
    def __init__(self, index):
        self.index = index
        self.META = ["sample_name", "geo_loc_name", "isolation_source", "strain", "host"]
    ...
    def from_bioproject (bioproject, delim = "EXPERIMENT_PACKAGE"):
        ...
        sra_accessions = [record.attrs["accession"] for record in sra_records("EXPERIMENT")]
    ...
    def fetch_metadata (self):
        ...
        for _,run in self:
            ...
            try:
                meta_dict["taxonomy_name"] = s.Description.Organism.attrs["taxonomy_name"]
            except:
